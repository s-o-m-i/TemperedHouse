...
const CoreValues = () => {
  const values = [
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 text-[#9f193f]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <section className="py-24 px-8 md:px-16 bg-[#f8f8f8] relative overflow-hidden">
      ...
      <div className="container mx-auto relative z-10">
        <div className="max-w-3xl mx-auto text-center mb-16">
          <span className="inline-block px-4 py-2 bg-[#28536B]/10 text-[#28536B] rounded-full text-sm font-semibold mb-6">
            Our Core Values
          </span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {values.map((value, index) => (
            ...
            >
              <div className="mb-6 p-4 inline-block bg-[#9f193f]/10 rounded-xl group-hover:bg-[#9f193f]/20 transition-colors duration-300">
                {value.icon}
              </div>
              <h3 className="text-xl font-bold text-[#28536B] mb-3">{value.title}</h3>
